...
export default function PrivacyPage() { return <LegalPage title="Aviso de Privacidade" updated="27 de julho de 2026">
  ...
  <h2>4. Publicidade e estatísticas</h2><p>Não há publicidade nem análise comportamental externa na v1.8.4. Uma futura ativação exigirá atualização deste aviso e nova oportunidade de escolha antes do carregamento de tecnologias opcionais.</p>
