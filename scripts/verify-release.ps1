...
if (Test-Path $userLock) {
  Write-Warning "Existe outro package-lock.json em $userLock. O projeto fixa a raiz do Turbopack, mas remova ou renomeie esse arquivo caso ele não pertença a outro projeto."
}
